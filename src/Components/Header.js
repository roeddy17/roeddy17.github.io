      ...
      <div className="flex justify-between items-center py-2 md:py-10">
        <div className="flex items-center space-x-4">
          <button onClick={toggleTheme}>
            {theme === "light" ? (
              <MoonIcon className="h-6 w-6 text-dark-heading" />
            ) : (
              <SunIcon className="h-6 w-6 text-light-heading" />
            )}
          </button>
            ...
            <a href={github} target="_blank" rel="noreferrer noopener">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M15 0C6.7125 0 0 6.7125 0 15C0 21.6375 4.29375 27.2437 10.2563 29.2313C11.0063 29.3625 11.2875 28.9125 11.2875 28.5188C11.2875 28.1625 11.2688 26.9813 11.2688 25.725C7.5 26.4188 6.525 24.8062 6.225 23.9625C6.05625 23.5312 5.325 22.2 4.6875 21.8438C4.1625 21.5625 3.4125 20.8687 4.66875 20.85C5.85 20.8313 6.69375 21.9375 6.975 22.3875C8.325 24.6562 10.4812 24.0187 11.3438 23.625C11.475 22.65 11.8688 21.9937 12.3 21.6187C8.9625 21.2437 5.475 19.95 5.475 14.2125C5.475 12.5813 6.05625 11.2313 7.0125 10.1813C6.8625 9.80625 6.3375 8.26875 7.1625 6.20625C7.1625 6.20625 8.41875 5.8125 11.2875 7.74375C12.4875 7.40625 13.7625 7.2375 15.0375 7.2375C16.3125 7.2375 17.5875 7.40625 18.7875 7.74375C21.6562 5.79375 22.9125 6.20625 22.9125 6.20625C23.7375 8.26875 23.2125 9.80625 23.0625 10.1813C24.0188 11.2313 24.6 12.5625 24.6 14.2125C24.6 19.9688 21.0375 21.2437 17.7 21.6187C18.225 22.0687 18.675 22.9125 18.675 24.2625C18.675 26.175 18.6563 27.8625 18.6563 28.5188C18.6563 28.9125 18.9375 29.3813 19.6875 29.2313C25.6688 27.2437 30 21.6375 30 15C30 6.7125 23.2875 0 15 0Z"
                />
              </svg>
            </a>
          </li>
